...
$sql = "SELECT Company_Name,Package_Name,Volume,Price,Validity,Activation_code from sms where price=(select min(price) from sms where Validity=1) and Validity=1 ";
...
<B><center><h1><a href="/index.php">Home </a>| Downloads | About Us | Contact Us</h1> </center></B>


<center>

<h1>Lowest Cost Daily SMS Packages</h1>
